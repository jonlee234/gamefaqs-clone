...
urlpatterns = [
    ...
    path("user/<int:CustomUser_id>/", user_profile_view, name="userProfile"),
    path("favorite_game/<int:game_id>", favorite_game_view, name="favorite-game"),
    path("unfavorite_game/<int:game_id>", unfavorite_game_view, name="unfavorite-game"),
